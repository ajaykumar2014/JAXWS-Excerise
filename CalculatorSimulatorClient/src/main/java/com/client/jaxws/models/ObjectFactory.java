 ...
 * generated in the com.web.services package. 
...
public class ObjectFactory {
    ...
    private final static QName _DivideResponse_QNAME = new QName("http://services.web.com/", "divideResponse");
    private final static QName _Divide_QNAME = new QName("http://services.web.com/", "divide");
    private final static QName _Multiply_QNAME = new QName("http://services.web.com/", "multiply");
    private final static QName _Add_QNAME = new QName("http://services.web.com/", "add");
    private final static QName _Subtract_QNAME = new QName("http://services.web.com/", "subtract");
    private final static QName _SubtractResponse_QNAME = new QName("http://services.web.com/", "subtractResponse");
    private final static QName _AddResponse_QNAME = new QName("http://services.web.com/", "addResponse");
    private final static QName _MultiplyResponse_QNAME = new QName("http://services.web.com/", "multiplyResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.web.services
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.web.com/", name = "divideResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.web.com/", name = "divide")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.web.com/", name = "multiply")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.web.com/", name = "add")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.web.com/", name = "subtract")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.web.com/", name = "subtractResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.web.com/", name = "addResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.web.com/", name = "multiplyResponse")
